...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 29, 10, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 29, 13, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 29, 20, 0), "Ужин", 500),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 30, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 30, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 30, 20, 0), "Ужин", 510)
    );
